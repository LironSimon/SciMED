    ...
    def run(numerical_bool: bool,
        ...
        for noise in noise_list:
            ...
            if numerical_bool:
                ...
                if feature_indexes_ranges == "Not applicable":
                    ...
                    all_t_scores, best_t_model = MultiTPOTrunner.run_and_analyze(run_times=numerical_run_times,
                                                                                 ...
                                                                                 k_fold=k_fold,
                                                                                 performance_metric="neg_mean_absolute_error",
            ...
            if analytical_bool:
                ...
                ebs_flag = ResultTracker.summaries_symbolic_results(run_times=analytical_run_times,
